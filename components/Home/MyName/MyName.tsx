  ...
  return (
    ...
    >
      ...
      >
        ...
        digital experiences. My current area of focus is in the <span className="text-AAsecondary">AI + Web</span>,
        where I actively engage in developing <br className="2xl:block hidden"/>
        and designing immersive <span className="text-AAsecondary">new-age applications</span>. This involves working with{" "}
        <span className="text-AAsecondary">LLMs, APIs and React</span>  for a{" "}
        <span className="text-AAsecondary">Full-Stack Environment</span>. 
